(function ($, wc_stripe) {
    ...
    Afterpay.prototype.add_eligibility = function () {
        if ($(this.container).length && !this.params.msg_options.isEligible) {
            $('#wc_stripe_local_payment_stripe_afterpay').addClass('ineligible');
        }
    }

    Afterpay.prototype.updated_checkout = function () {
        this.maybe_hide_gateway();
        this.add_eligibility();
    ...
    Afterpay.prototype = $.extend({}, LocalPayment.prototype, Afterpay.prototype);
